...
$string['webhookdesc'] = 'This is the endpoint that receives and handles updates from the set Telegram Bot. Leave this field blank to not setup a webhook.';
$string['webhookset'] = 'Webhook successfully set.';
